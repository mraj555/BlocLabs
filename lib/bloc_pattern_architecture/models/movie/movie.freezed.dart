...
mixin _$Movie {
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is Movie && (identical(other.total, total) || other.total == total) &&
            (identical(other.page, page) || other.page == page) && (identical(other.pages, pages) || other.pages == pages) &&
            const DeepCollectionEquality().equals(other.tv_shows, tv_shows));
  }
...
abstract mixin class $MovieCopyWith<$Res> {
  ...
  @useResult
  $Res call({
    String total, int page, int pages, List<Shows> tv_shows
  });
...
class _$MovieCopyWithImpl<$Res>
  ...
  @pragma('vm:prefer-inline')
  @override
  $Res call({Object? total = null, Object? page = null, Object? pages = null, Object? tv_shows = null,}) {
...
extension MoviePatterns on Movie {
  ...
  TResult Function( _Movie value)? $default,{required TResult orElse(),}){
  final _that = this;
  switch (_that) {
  ...
  @optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String total, int page, int pages, List<Shows> tv_shows)? $default,{required TResult orElse(),}) {final _that = this;
  switch (_that) {
  case _Movie() when $default != null:
  ...
  @optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String total, int page, int pages, List<Shows> tv_shows) $default,) {final _that = this;
  switch (_that) {
  case _Movie():
  return $default(_that.total,_that.page,_that.pages,_that.tv_shows);case _:
  throw StateError('Unexpected subclass');
  ...
  @optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String total, int page, int pages, List<Shows> tv_shows)? $default,) {final _that = this;
  switch (_that) {
  case _Movie() when $default != null:
  return $default(_that.total,_that.page,_that.pages,_that.tv_shows);case _:
  return null;
...
class _Movie implements Movie {
  _Movie({this.total = '', this.page = 0, this.pages = 0, final List<Shows> tv_shows = const []}) : _tv_shows = tv_shows;
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType && other is _Movie && (identical(other.total, total) || other.total == total) &&
            (identical(other.page, page) || other.page == page) && (identical(other.pages, pages) || other.pages == pages) &&
