...
mixin _$Shows {
 ...
 String get name; String get permalink; String get end_date; String get network; String get image_thumbnail_path; String get status;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Shows&&(identical(other.name, name) || other.name == name)&&(identical(other.permalink, permalink) || other.permalink == permalink)&&(identical(other.end_date, end_date) || other.end_date == end_date)&&(identical(other.network, network) || other.network == network)&&(identical(other.image_thumbnail_path, image_thumbnail_path) || other.image_thumbnail_path == image_thumbnail_path)&&(identical(other.status, status) || other.status == status));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,name,permalink,end_date,network,image_thumbnail_path,status);
...
/// Create a copy of Shows
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? name = null,Object? permalink = null,Object? end_date = null,Object? network = null,Object? image_thumbnail_path = null,Object? status = null,}) {
...
as String,image_thumbnail_path: null == image_thumbnail_path ? _self.image_thumbnail_path : image_thumbnail_path // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _Shows value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
...
@override@JsonKey() final  String end_date;
@override@JsonKey() final  String network;
@override@JsonKey() final  String image_thumbnail_path;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Shows&&(identical(other.name, name) || other.name == name)&&(identical(other.permalink, permalink) || other.permalink == permalink)&&(identical(other.end_date, end_date) || other.end_date == end_date)&&(identical(other.network, network) || other.network == network)&&(identical(other.image_thumbnail_path, image_thumbnail_path) || other.image_thumbnail_path == image_thumbnail_path)&&(identical(other.status, status) || other.status == status));
}
...
/// Create a copy of Shows
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? name = null,Object? permalink = null,Object? end_date = null,Object? network = null,Object? image_thumbnail_path = null,Object? status = null,}) {
  return _then(_Shows(
name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,permalink: null == permalink ? _self.permalink : permalink // ignore: cast_nullable_to_non_nullable
as String,end_date: null == end_date ? _self.end_date : end_date // ignore: cast_nullable_to_non_nullable
